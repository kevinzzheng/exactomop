    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('measurement_date', models.DateField(help_text='Date of biomarker measurement', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('invalid_reason', models.CharField(blank=True, help_text='Reason concept is invalid', max_length=1, null=True)),
            ],
            options={
                'db_table': 'concept',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('stop_reason', models.CharField(blank=True, help_text='Reason condition ended', max_length=20, null=True)),
                ...
                ('condition_status_source_value', models.CharField(blank=True, help_text='Source status value', max_length=50, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lot_number', models.CharField(blank=True, help_text='Lot number', max_length=50, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('unit_source_value', models.CharField(blank=True, help_text='Source unit value', max_length=50, null=True)),
                ...
                ('expression_level', models.CharField(blank=True, choices=[('NEGATIVE', 'Negative (0%)'), ('LOW', 'Low (1-10%)'), ('MODERATE', 'Moderate (11-50%)'), ('HIGH', 'High (>50%)'), ('OVEREXPRESSED', 'Overexpressed')], help_text='Biomarker expression level classification', max_length=20, null=True)),
                ('ihc_score', models.CharField(blank=True, choices=[('0', 'Score 0'), ('1+', 'Score 1+'), ('2+', 'Score 2+'), ('3+', 'Score 3+')], help_text='IHC intensity score', max_length=10, null=True)),
                ...
                ('mutation_status', models.CharField(blank=True, choices=[('WILD_TYPE', 'Wild Type'), ('MUTATED', 'Mutated'), ('UNKNOWN', 'Unknown'), ('NOT_TESTED', 'Not Tested')], help_text='Mutation status', max_length=20, null=True)),
                ...
                ('msi_status', models.CharField(blank=True, choices=[('MSI_HIGH', 'MSI-High'), ('MSI_LOW', 'MSI-Low'), ('MSS', 'Microsatellite Stable')], help_text='Microsatellite instability status', max_length=15, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('detail_date', models.DateField(blank=True, help_text='Date of this episode detail', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('trial_identifier', models.CharField(blank=True, help_text='Clinical trial identifier', max_length=100, null=True)),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, help_text='OMOP concept for biomarker', null=True, on_delete=django.db.models.deletion.PROTECT, related_name='biomarker_measurements', to='omop.concept'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, help_text='Concept for radiation therapy type', null=True, on_delete=django.db.models.deletion.PROTECT, related_name='radiation_occurrences', to='omop.concept'),
        ),
        migrations.AddField(
            model_name='radiationoccurrence',
            name='radiation_type_concept',
            field=models.ForeignKey(blank=True, help_text='Type of radiation therapy', null=True, on_delete=django.db.models.deletion.PROTECT, related_name='radiation_types', to='omop.concept'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, help_text='Primary condition being treated', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='treatment_lines', to='omop.conditionoccurrence'),
        ),
        migrations.AddField(
            model_name='treatmentline',
            name='person',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, help_text='Concept for assessment type', null=True, on_delete=django.db.models.deletion.PROTECT, related_name='tumor_assessments', to='omop.concept'),
        ),
        migrations.AddField(
            model_name='tumorassessment',
            name='assessment_type_concept',
            field=models.ForeignKey(blank=True, help_text='Type of tumor assessment', null=True, on_delete=django.db.models.deletion.PROTECT, related_name='assessment_types', to='omop.concept'),
        ),
        migrations.AddField(
            model_name='tumorassessment',
            name='person',
