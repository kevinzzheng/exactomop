...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.IntegerField(default=1, help_text='Length of each cycle in days'),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(default=0, help_text='Concept for regimen type', on_delete=django.db.models.deletion.PROTECT, related_name='treatment_regimens', to='omop.concept'),
            preserve_default=False,
        ),
        migrations.AddField(
            model_name='treatmentregimen',
        ...
        migrations.AddField(
            ...
            field=models.CharField(choices=[('INPATIENT', 'Inpatient'), ('OUTPATIENT', 'Outpatient'), ('AMBULATORY', 'Ambulatory')], default=None, help_text='Treatment setting', max_length=20),
            preserve_default=False,
        ),
        ...
        migrations.AlterField(
            model_name='treatmentregimen',
            name='best_response',
            field=models.CharField(choices=[('CR', 'Complete Response'), ('PR', 'Partial Response'), ('SD', 'Stable Disease'), ('PD', 'Progressive Disease'), ('NE', 'Not Evaluable'), ('MR', 'Mixed Response')], help_text='Best overall response to regimen', max_length=20),
        ),
        migrations.AlterField(
            model_name='treatmentregimen',
        ...
        migrations.AlterField(
            model_name='treatmentregimen',
            name='regimen_code',
            field=models.CharField(help_text='Standard regimen code', max_length=50),
        ),
        migrations.AlterField(
            model_name='treatmentregimen',
            name='regimen_name',
